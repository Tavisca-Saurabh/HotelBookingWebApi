...
namespace HotelService
{
    ...
    {
        [OperationContract]
        //[WebInvoke(Method ="GET",UriTemplate ="/GetHotelDetails/{HotelID}",RequestFormat =WebMessageFormat.Json,
        //    ResponseFormat =WebMessageFormat.Json,BodyStyle =WebMessageBodyStyle.Wrapped)]
        [WebGet(UriTemplate = "/GetHotelDetails/{HotelID}", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json)]
